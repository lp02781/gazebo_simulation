...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/mfikih15/gazebo_simulation/src/pid)
  set(pid_DEVEL_PREFIX /home/mfikih15/gazebo_simulation/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/mfikih15/gazebo_simulation/install)
...
if(NOT "/home/mfikih15/gazebo_simulation/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mfikih15/gazebo_simulation/src/pid/${idir}'.  ${_report}")
    endif()
